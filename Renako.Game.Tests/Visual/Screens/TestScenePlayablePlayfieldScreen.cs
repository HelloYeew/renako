...
public partial class TestScenePlayablePlayfieldScreen : RenakoGameDrawableTestScene
{
    ...
    [Test]
    public void TestPlayablePlayfieldScreen()
    {
        ...
        AddStep("add player loading screen", () => MainScreenStack.Push(new PlayablePlayfieldScreen()));
        AddAssert("screen loaded", () => MainScreenStack.CurrentScreen is PlayablePlayfieldScreen);
        AddStep("rerun", () =>
        {
